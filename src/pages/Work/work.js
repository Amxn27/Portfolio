...
import image1 from '../../assets/images/SmartWriteAi.png';
import image2 from '../../assets/images/wheather app.png';
import image3 from '../../assets/images/bgchanger.png';
            ...
            <div className="projects">
                <div className="single">
                    <div className="single-img">
                        <img src={image1} alt="SmartWrite AI" />
                    </div>
                    <div className="single-detail">
                        <h4>SmartWriterAI</h4>
                        <p>
                            “SmartWriterAI” is an advanced content generation platform built on cutting-edge technologies including
                            React.js, Next.js, PostgreSQL, Tailwind CSS, and powered by the Gemini API. This innovative tool leverages artificial
                            intelligence to create high-quality content across multiple formats and industries.
                        </p>
                ...
                <div className="single reverse">
                    <div className="single-img">
                        <img src={image2} alt="Weather App" />
                    </div>
                    <div className="single-detail">
                        <h4>Weather App</h4>
                        <p>Weather App is a simple, user-friendly web application that allows users to check the current weather conditions for any location around the globe. The app fetches real-time weather data using an external weather API and displays it in an intuitive interface. Users can enter a city name or use their location to receive up-to-date weather information, including temperature, humidity, wind speed, and a brief weather description</p>
                        <div className="button-wrap">
                            <button className="button" href={{}}>Visit &rarr;</button>
                        </div>
                    </div>
                </div>
                <div className="single">
                    <div className="single-img">
                        <img src={image3} alt="Background Changer" />
                    </div>
                    <div className="single-detail">
                        <h4>React Bg Changer </h4>
                        <p>The Background Changer App is allows users to change the background color webpage with the click of a button. This app leverages React's component-based architecture to create a seamless user experience. Users can choose from a predefined set of colors of the app dynamically.</p>
                        <div className="button-wrap">
                            <button className="button">Visit &rarr;</button>
                        </div>
                    </div>
